            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="./index2.php">Employee</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./attend.php">Attendance</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-md-offset-3">
                ...
                <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#" a> <a href="/rfid/attendPrint.php">Print Attendance</a> </button> -->
                            ...
                            <div class="modal-body">
                                ...
                                <form action="add.php" method="post">
                                    <div class="form-group">
                                        ...
                                        Dept :<input type="text" name="dept" class="form-control" id="newtask" placeholder="">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="search.php" method="GET">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"></label>
                                        search words:<input type="text" name="name" class="form-control" id="newtask" placeholder="">
                                    </div>
